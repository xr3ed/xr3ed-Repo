 ...
 *  - Once found the cookies are persisted via [AniDbPlugin] and the dialog closes automatically.
 */
class CloudflareWebViewDialog(
    ...
    companion object {
        private const val TAG = "AniDB_CFWebViewDialog"
    ...
    private fun saveCookiesAndDismiss(cookieStr: String) {
        ...
        AniDbPlugin.cfCookies    = cookieStr
        AniDbPlugin.cfCookieHost = targetHost
        webView?.settings?.userAgentString?.let { ua ->
            AniDbPlugin.cfUserAgent = ua
        }
